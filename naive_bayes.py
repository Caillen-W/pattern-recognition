...
def run_main():
    ...
    problity_of_unSurvived, problity_of_female_unSurvived, problity_of_old_unSurvived, problity_of_rich_unSurvived,\
    problity_of_female_Survived, problity_of_old_Survived, problity_of_rich_Survived = compute_probability(r'./train.csv')
    with open(r'./test.csv', 'r') as f:
        reader = csv.DictReader(f)
        for row in reader:
            pre = predict(row['Age'], row['Sex'], row['Fare'], problity_of_unSurvived, problity_of_female_unSurvived,
                          problity_of_old_unSurvived,problity_of_rich_unSurvived,problity_of_female_Survived,
                          problity_of_old_Survived,problity_of_rich_Survived)
            pre_list.append(pre)
